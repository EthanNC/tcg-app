...
CREATE TABLE IF NOT EXISTS "card_printings" (
	...
	CONSTRAINT "card_printings_unique_id_card_id_edition_art_variation_key" UNIQUE(
		"unique_id",
		"card_id",
		"edition",
		"art_variation"
...
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "set_printings"
ADD CONSTRAINT "set_printings_set_unique_id_fkey" FOREIGN KEY ("set_unique_id") REFERENCES "public"."sets"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
...
ADD CONSTRAINT "card_printings_card_unique_id_fkey" FOREIGN KEY ("card_unique_id") REFERENCES "public"."cards"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "card_printings"
ADD CONSTRAINT "card_printings_set_printing_unique_id_fkey" FOREIGN KEY ("set_printing_unique_id") REFERENCES "public"."set_printings"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "card_face_associations"
ADD CONSTRAINT "card_face_associations_back_unique_id_fkey" FOREIGN KEY ("back_unique_id") REFERENCES "public"."card_printings"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "card_face_associations"
ADD CONSTRAINT "card_face_associations_front_unique_id_fkey" FOREIGN KEY ("front_unique_id") REFERENCES "public"."card_printings"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "card_references"
ADD CONSTRAINT "card_references_card_unique_id_fkey" FOREIGN KEY ("card_unique_id") REFERENCES "public"."cards"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "card_references"
ADD CONSTRAINT "card_references_referenced_card_unique_id_fkey" FOREIGN KEY ("referenced_card_unique_id") REFERENCES "public"."cards"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "ability_translations"
ADD CONSTRAINT "ability_translations_ability_unique_id_fkey" FOREIGN KEY ("ability_unique_id") REFERENCES "public"."abilities"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
ADD CONSTRAINT "type_translations_type_unique_id_fkey" FOREIGN KEY ("type_unique_id") REFERENCES "public"."types"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
ADD CONSTRAINT "keyword_translations_keyword_unique_id_fkey" FOREIGN KEY ("keyword_unique_id") REFERENCES "public"."keywords"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
ADD CONSTRAINT "card_translations_card_unique_id_fkey" FOREIGN KEY ("card_unique_id") REFERENCES "public"."cards"("unique_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;